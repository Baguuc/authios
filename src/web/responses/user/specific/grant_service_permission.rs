...
impl From<Result<(), crate::errors::use_case::SpecificUserGrantServicePermissionError>> for SpecificUserGrantServicePermissionResponse {
    fn from(result: Result<(), crate::errors::use_case::SpecificUserGrantServicePermissionError>) -> Self {
...
impl Into<actix_web::HttpResponse> for SpecificUserGrantServicePermissionResponse {
