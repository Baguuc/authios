...
pub async fn controller(
    ...
    use crate::params::use_case::SpecificUserCheckServicePermissionParams as Params;
    use crate::use_cases::SpecificUserUseCase as UseCase;
    use crate::web::responses::SpecificUserCheckServicePermissionResponse as Response;
